...
const SongDetails = () => {
    ...
    const { data: songData, isFetching: useFetchingSongDetails } = useGetSongDetailsQuery(songid);
    ...
    if (isFetchingRelatedSongs || isFetchingRelatedSongs) return <Loader title="Searching song details" />;
