...
const TopChartCard =({song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick}) =>(
  <div className="w-fullflex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2">
    <h3 className="font-bold text-base text-white mr-3">{i+1}</h3>
    <div className="flex-1 flex flex-row justify-between items-center">
    <img
      className="w-20 h-20 rounded-lg"
      src={song?.images?.coverart} // Fixed the typo
      alt={song?.title}/>
...
const TopPlay = () => {
  ...
  return (
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mg-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
